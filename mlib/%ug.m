%ug ; FreeM Global Utility menu - version 0.5.0.1
...
%read s a="",error=$$readn^%uxxxx("Choose option ",.a) i error<0 q
 ...
 g %read
 ;
%menu ;Global Compare;^%ugcom
 ;Global Copy;^%ugcop
 ;Global Directory;^%ugdir
 ;Global Delete;^%ugdel
 ;Global Edit;^%ugedi
 ;Global Export;^%ugexp
 ;Global Import;^%ugimp
 ;Global Lister;^%uglis
 ;Alternative Global Lister;^%uglis2
 ;Global Search/Replace;^%ugsea
 q
